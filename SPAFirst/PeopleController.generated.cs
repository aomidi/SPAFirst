...
namespace SPAFirst.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PeopleController : SPAFirst.Controllers.PeopleController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, SPAFirst.Models.Person person);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(SPAFirst.Models.Person person)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, SPAFirst.Models.Person person);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(SPAFirst.Models.Person person)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "person", person);
